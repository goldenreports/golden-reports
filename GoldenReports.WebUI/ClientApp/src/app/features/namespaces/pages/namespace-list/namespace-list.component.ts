...
import { namespaceListPageActions, NamespaceListPageSelectors } from '@features/namespaces/store/namespace-list-page';
...
export class NamespaceListComponent {
  ...
  public saveNamespace(newChild: CreateNamespaceDto): void {
    this.store.dispatch(namespaceListPageActions.childNamespaceSubmitted({ namespace: newChild }));
  }
