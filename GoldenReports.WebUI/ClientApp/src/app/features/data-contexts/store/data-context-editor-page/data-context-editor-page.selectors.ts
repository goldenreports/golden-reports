...
export class DataContextEditorPageSelectors {
  public static readonly getState = createSelector(selectDataContextFeature, state => state[DataContextEditorPageStateKey]);

  public static readonly getLoadingFlag = createSelector(DataContextEditorPageSelectors.getState, state => state?.loading);
  ...
  public static readonly getDataContext = createSelector(
    ...
    (dataContexts, selectedDataContextId) => selectedDataContextId ? dataContexts[selectedDataContextId] : null);

  public static readonly getSavingFlag = createSelector(DataContextEditorPageSelectors.getState, state => state?.saving);

  public static readonly getError = createSelector(DataContextEditorPageSelectors.getState, state => state?.error);

  public static readonly getHasValidDataFlag = createSelector(DataContextEditorPageSelectors.getState, state => state?.hasValidData);
