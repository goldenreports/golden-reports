...
namespace GoldenReports.Persistence.Migrations
{
    ...
    [Migration("20221229160326_ReplaceAltKeysWithIndex")]
    partial class ReplaceAltKeysWithIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GoldenReports.Domain.Reports.ReportPage", b =>
                {
                    ...
                    b.HasIndex("ReportId", "Name")
                        .IsUnique()
                        .HasDatabaseName("UK_ReportPage_Name");
            ...
            modelBuilder.Entity("GoldenReports.Domain.Reports.ReportSection", b =>
                {
                    ...
                    b.HasIndex("PageId", "Name")
                        .IsUnique()
                        .HasDatabaseName("UK_ReportSection_Name");
