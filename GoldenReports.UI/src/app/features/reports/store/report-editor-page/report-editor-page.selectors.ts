...
export class ReportEditorPageSelectors {
  public static readonly getState = createSelector(selectReportFeature, state => state[ReportEditorPageStateKey]);

  public static readonly getLoadingFlag = createSelector(ReportEditorPageSelectors.getState, (state) => state.loading);

  public static readonly getError = createSelector(ReportEditorPageSelectors.getState, (state) => state.error);
