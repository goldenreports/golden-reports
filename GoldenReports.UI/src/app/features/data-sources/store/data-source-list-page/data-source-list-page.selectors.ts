...
export class DataSourceListPageSelectors {
  public static readonly getState = createSelector(selectDataSourceFeature, state => state[DataSourceListPageStateKey]);

  public static readonly getLoadingFlag = createSelector(DataSourceListPageSelectors.getState, state => state?.loading);

  public static readonly getError = createSelector(DataSourceListPageSelectors.getState, state => state?.error);

  public static readonly getDataSources = createSelector(
    DataSourceSelectors.getAll,
    RouterSelectors.getParam('namespaceId'),
    (sources, namespaceId) => sources.filter(x => x.namespaceId === namespaceId));
